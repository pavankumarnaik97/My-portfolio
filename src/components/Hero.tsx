...
const FLOAT_TAGS = [
  { label: 'React', className: 'left-[-14px] top-10 sm:left-[-22px]' },
  { label: 'TypeScript', className: 'right-[-10px] top-1/3 sm:right-[-18px]' },
    ...
    >
      ...
      <div className="section-shell relative grid gap-16 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        ...
        >
          ...
          >
            Hi, I&apos;m Pavan Naik — Frontend Developer
          </motion.p>
          ...
          >
            Frontend developer with 5+ years of experience building responsive web apps,
            AEM experiences, and React-based interfaces for e-commerce, enterprise, and CMS-driven platforms.
          </motion.p>
        ...
        >
          ...
          <div className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-[2rem] border border-white/10 bg-base-raised/80">
            <div className="pointer-events-none absolute inset-0 bg-grid-pattern bg-[size:28px_28px] opacity-40" />
            <span className="relative font-display text-8xl italic text-ink/90">PN</span>
            <span className="relative mt-3 font-mono text-[11px] uppercase tracking-[0.3em] text-ink-faint">
              EST. 2020
            </span>
          </div>
